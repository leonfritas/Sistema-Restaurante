...
begin
  ...
  begin
     totalRecebido := totalRecebido + ADOFinanceiroMovimentoRealizado.FieldByName('valorMovimento').AsCurrency;
     ADOFinanceiroMovimentoRealizado.Next;
  end;
  //
  lblValorTotal.Caption :=  'R$ ' + FormatFloat(',0.00', StrToFloat(CurrToStr(totalRecebido)));
end;
