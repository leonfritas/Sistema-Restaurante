...
type
  TfrmCadastroFuncionario = class(TForm)
    ...
    procedure srcFuncionarioDataChange(Sender: TObject; Field: TField);
  private
...
procedure TfrmCadastroFuncionario.srcFuncionarioDataChange(Sender: TObject;
  Field: TField);
begin
  btnSalvar.Visible := (srcFuncionario.State = dsEdit) or (srcFuncionario.State = dsInsert);
  btnCancelar.Visible := (srcFuncionario.State = dsEdit) or (srcFuncionario.State = dsInsert);
  //
